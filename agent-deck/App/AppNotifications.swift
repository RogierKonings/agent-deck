...
extension Notification.Name {
    ...
    static let agentDeckDreamMemoryRequested = Notification.Name("agentDeckDreamMemoryRequested")
    static let agentDeckRefreshMemoryRequested = Notification.Name("agentDeckRefreshMemoryRequested")
